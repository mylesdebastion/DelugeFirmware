...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING, "Note Color Mapping"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_OFF, "Off"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_CHROMATIC, "Chromatic"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_HARMONIC, "Harmonic"},
        ...
        {STRING_FOR_ENV1_ATTACK_MENU_TITLE, "Env1 attack"},
        {STRING_FOR_ENV1_DECAY_MENU_TITLE, "Env1 decay"},
        {STRING_FOR_ENV1_SUSTAIN_MENU_TITLE, "Env1 sustain"},
        {STRING_FOR_ENV1_RELEASE_MENU_TITLE, "Env1 release"},
        {STRING_FOR_ENV2_ATTACK_MENU_TITLE, "Env2 attack"},
        {STRING_FOR_ENV2_DECAY_MENU_TITLE, "Env2 decay"},
        {STRING_FOR_ENV2_SUSTAIN_MENU_TITLE, "Env2 sustain"},
        {STRING_FOR_ENV2_RELEASE_MENU_TITLE, "Env2 release"},
        {STRING_FOR_ENV3_ATTACK_MENU_TITLE, "Env3 attack"},
        {STRING_FOR_ENV3_DECAY_MENU_TITLE, "Env3 decay"},
        {STRING_FOR_ENV3_SUSTAIN_MENU_TITLE, "Env3 sustain"},
        {STRING_FOR_ENV3_RELEASE_MENU_TITLE, "Env3 release"},
        {STRING_FOR_ENV4_ATTACK_MENU_TITLE, "Env4 attack"},
        {STRING_FOR_ENV4_DECAY_MENU_TITLE, "Env4 decay"},
        {STRING_FOR_ENV4_SUSTAIN_MENU_TITLE, "Env4 sustain"},
        {STRING_FOR_ENV4_RELEASE_MENU_TITLE, "Env4 release"},
