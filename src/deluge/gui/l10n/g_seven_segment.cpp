...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING, "NCOL"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_OFF, "OFF"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_CHROMATIC, "CHRO"},
        {STRING_FOR_COMMUNITY_FEATURE_NOTE_COLOR_MAPPING_HARMONIC, "HARM"},
